...
## Tasks
- [] Add `Player` class, which represents the AI program. It should be able to interact with the Luchang's AI bots, using std `fork()` and `pipe()` etc. to communicate.
- [] Add `Battle` class to coordinate the players' moves and store them.
- [] Using openGL to display the board
